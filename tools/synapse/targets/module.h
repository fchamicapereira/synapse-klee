...
enum class ModuleType {
  ...
  Tofino_TTLCachedTableRead,
  Tofino_TTLCachedTableReadOrWrite,
  Tofino_TTLCachedTableWrite,
  Tofino_TTLCachedTableConditionalDelete,
  Tofino_TTLCachedTableDelete,
  Tofino_Recirculate,
  TofinoCPU_Ignore,
  ...
  TofinoCPU_TTLCachedTableRead,
  TofinoCPU_TTLCachedTableWrite,
  TofinoCPU_TTLCachedTableDelete,
